...
<!-- page contents ------------------------------------------------------------------------------------------------------>
	...
	<!-- page contents ------------------------------------------------------------------------------------------------------>	
	 <div class="toolframe" id="pic_frame">
	 	<img id="treatments_pic" src="{{asset('assets/images/treatments_pic.png')}}">
	 </div>
	...
	<div id="tool_bar_container">
		<div id="tool_bar">
			...
			<div class="selected_tool" id="tracker6" style="opacity:1.0"><a href="treatmentplan"><img src="{{ asset('assets/images/icon_treatments.png') }}"></a></div>
